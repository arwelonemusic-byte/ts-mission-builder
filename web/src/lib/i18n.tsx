...
const RU: Record<string, string> = {
  ...
  "Enemy AI calls in mortar strikes on players spotted by its troops.":
    "ИИ противника вызывает миномётные удары по игрокам, замеченным его войсками.",
  ...
  "Players entering the trigger stop the enemy artillery for the rest of the mission. Without one it fires until it runs out of rounds.":
    "Когда игроки входят в триггер, артиллерия противника прекращает огонь до конца миссии. Без триггера она стреляет, пока не кончатся снаряды.",
  "Add Stop Artillery Trigger": "Добавить триггер остановки",
  "Remove trigger": "Удалить триггер",
  "the stop-artillery trigger": "триггер остановки артиллерии",
  ...
  // Zones tab — Advanced AI placement (2026-09-21)
  Simple: "Обычный",
  Advanced: "Расширенный",
  "Foot patrols": "Пешие патрули",
  "Mounted patrols": "Патрули на технике",
  "Defense groups": "Группы обороны",
  "Static AI soldiers": "Статичные бойцы",
  "Patrol groups with manually placed cycled waypoints.": "Группы, патрулирующие по заданному вами замкнутому маршруту.",
  "Patrol groups on vehicles with manually placed cycled waypoints.": "Группы на технике, патрулирующие по заданному вами замкнутому маршруту.",
  "AI groups defending an area with a custom radius.": "Группы, обороняющие область заданного радиуса.",
  "AI characters that don't move. They will still shoot and turn.": "Бойцы, которые не двигаются с места, но поворачиваются и стреляют.",
  "Add foot patrol": "Добавить пеший патруль",
  "Add mounted patrol": "Добавить патруль на технике",
  "Add defense group": "Добавить группу обороны",
  "Add static soldier": "Добавить статичного бойца",
  "Foot patrol": "Пеший патруль",
  "Mounted patrol": "Патруль на технике",
  "Defense group": "Группа обороны",
  "Static soldier": "Статичный боец",
  "Add waypoint": "Добавить точку маршрута",
  Waypoint: "Точка",
  "Delete waypoint": "Удалить точку маршрута",
  "Delete element": "Удалить",
  "Crew group": "Экипаж",
  Role: "Роль",
  Group: "Группа",
  "Defense radius": "Радиус обороны",
  "Needs at least one waypoint": "Нужна хотя бы одна точка маршрута",
  "Outside the zone circle — the despawn range is widened to cover it": "Вне круга зоны — радиус деспауна будет расширен",
  "Click the map to add waypoints… (finish)": "Кликайте по карте, добавляя точки… (готово)",
  "Maximum number of waypoints reached": "Достигнуто максимальное число точек",
  "Every manually placed patrol needs at least one waypoint (Zones tab, Advanced).": "У каждого вручную размещённого патруля должна быть хотя бы одна точка маршрута (вкладка Зоны, Расширенный).",
  ...
  "the patrol's spawn point": "точку появления патруля",
  "a patrol waypoint": "точку маршрута",
  "the defense group": "группу обороны",
  "the static soldier": "статичного бойца",
  "· press the button again to finish": "· нажмите кнопку ещё раз, чтобы закончить",
