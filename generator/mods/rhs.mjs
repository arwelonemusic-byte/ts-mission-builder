  ...
  factions: {
    RHS_USAF: {
      ...
      arsenalItems: [
        ...
        { mode: "AMMUNITION", ref: "{4EEDDB27C023B8B9}Prefabs/Weapons/Magazines/Box_556x45_M249_200rnd_Tracer.et" },
        ...
        { mode: "AMMUNITION", ref: "{AD8AB93729348C3E}Prefabs/Weapons/Magazines/Box_762x51_M60_100rnd_Tracer.et" },
        { mode: "AMMUNITION", ref: "{AAF51CFA75A9CF8B}Prefabs/Weapons/Magazines/Box_762x51_M60_100rnd_4AP_1Tracer.et" },
