...
export const ARMA2 = {
  ...
  factions: {
    Ses_CDF: {
      ...
      vehicleLabels: {
        UAZ469_CDF: "UAZ-469 (CDF)",
        UAZ469_uncovered_CDF: "UAZ-469 (uncovered, CDF)",
        UAZ452_transport_CDF: "UAZ-452 Van (CDF)",
        UAZ452_ambulance_CDF: "UAZ-452 Ambulance (CDF)",
        UAZ452_cargo_CDF: "UAZ-452 Cargo (CDF)",
        M998_CDF: "M998 HMMWV (CDF)",
        M998_covered_CDF: "M998 HMMWV (covered, CDF)",
        M998_covered_long_CDF: "M998 HMMWV (long, CDF)",
        M997_ambulance_CDF: "M997 Ambulance (CDF)",
        M1025_CDF: "M1025 HMMWV (CDF)",
        M1025_armed_M2HB_CDF: "M1025 M2HB (CDF)",
        BRDM2_CDF: "BRDM-2 (CDF)",
        BTR70_CDF: "BTR-70 (CDF)",
        Ural4320_transport_CDF: "Ural-4320 Truck (CDF)",
        Ural4320_transport_covered_CDF: "Ural-4320 Truck (covered, CDF)",
        Ural4320_ammo_CDF: "Ural-4320 Ammo Truck (CDF)",
        Ural4320_command_CDF: "Ural-4320 Command Truck (CDF)",
        Ural4320_engineer_CDF: "Ural-4320 Engineer Truck (CDF)",
        Ural4320_repair_CDF: "Ural-4320 Repair Truck (CDF)",
        Ural4320_tanker_CDF: "Ural-4320 Fuel Tanker (CDF)",
        Mi8MT_CDF: "Mi-8MT Transport (CDF)",
        Mi8MT_armed_CDF: "Mi-8MT (armed, CDF)",
        Mi8MT_gunship_HE_CDF: "Mi-8MT Gunship HE (CDF)",
        Mi8MT_gunship_HEDP_CDF: "Mi-8MT Gunship HEDP (CDF)",
      },
    ...
    Ses_ChDKZ: {
      ...
      vehicleLabels: {
        UAZ469_ChDKZ: "UAZ-469 (ChDKZ)",
        UAZ469_uncovered_ChDKZ: "UAZ-469 (uncovered, ChDKZ)",
        UAZ469_PKM_ChDKZ: "UAZ-469 PKM (ChDKZ)",
        UAZ452_transport_ChDKZ: "UAZ-452 Van (ChDKZ)",
        UAZ452_ambulance_ChDKZ: "UAZ-452 Ambulance (ChDKZ)",
        UAZ452_cargo_ChDKZ: "UAZ-452 Cargo (ChDKZ)",
        BRDM2_ChDKZ: "BRDM-2 (ChDKZ)",
        BTR70_ChDKZ: "BTR-70 (ChDKZ)",
        Ural4320_transport_ChDKZ: "Ural-4320 Truck (ChDKZ)",
        Ural4320_transport_covered_ChDKZ: "Ural-4320 Truck (covered, ChDKZ)",
        Ural4320_ammo_ChDKZ: "Ural-4320 Ammo Truck (ChDKZ)",
        Ural4320_command_ChDKZ: "Ural-4320 Command Truck (ChDKZ)",
        Ural4320_engineer_ChDKZ: "Ural-4320 Engineer Truck (ChDKZ)",
        Ural4320_repair_ChDKZ: "Ural-4320 Repair Truck (ChDKZ)",
        Ural4320_tanker_ChDKZ: "Ural-4320 Fuel Tanker (ChDKZ)",
      },
    ...
    Ses_NAPA: {
      ...
      vehicleLabels: {
        UAZ469_NAPA: "UAZ-469 (NAPA)",
        UAZ469_uncovered_NAPA: "UAZ-469 (uncovered, NAPA)",
        UAZ469_UK59_NAPA: "UAZ-469 UK-59 (NAPA)",
        BRDM2_NAPA: "BRDM-2 (NAPA)",
        BTR70_NAPA: "BTR-70 (NAPA)",
