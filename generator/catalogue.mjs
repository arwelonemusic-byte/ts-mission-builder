...
export const FACTIONS = {
  US: {
    ...
    arsenalItems: [
      { mode: "WEAPON", ref: "{3E413771E1834D2F}Prefabs/Weapons/Rifles/M16/Rifle_M16A2.et" },
      { mode: "WEAPON_VARIANTS", ref: "{5A987A8A13763769}Prefabs/Weapons/Rifles/M16/Rifle_M16A2_M203.et" },
      { mode: "WEAPON", ref: "{F97A4AC994231900}Prefabs/Weapons/Rifles/M16/Rifle_M16A2_carbine.et" },
      { mode: "WEAPON_VARIANTS", ref: "{EF73725A81669E2C}Prefabs/Weapons/Rifles/M16/Rifle_M16A2_carbine_M203.et" },
      { mode: "WEAPON", ref: "{D2B48DEBEF38D7D7}Prefabs/Weapons/MachineGuns/M249/MG_M249.et" },
      { mode: "WEAPON", ref: "{D182DCDD72BF7E34}Prefabs/Weapons/MachineGuns/M60/MG_M60.et" },
      { mode: "WEAPON", ref: "{B31929F65F0D0279}Prefabs/Weapons/Rifles/M14/Rifle_M21.et" },
      { mode: "WEAPON_VARIANTS", ref: "{81EB948E6414BD6F}Prefabs/Weapons/Rifles/M14/Rifle_M21_ARTII.et" },
      { mode: "WEAPON", ref: "{1353C6EAD1DCFE43}Prefabs/Weapons/Handguns/M9/Handgun_M9.et" },
      ...
      { mode: "AMMUNITION", ref: "{2EBF60EF24B108FC}Prefabs/Weapons/Magazines/Magazine_556x45_STANAG_30rnd_M855_Ball.et" },
      ...
      { mode: "AMMUNITION", ref: "{9C05543A503DB80E}Prefabs/Weapons/Magazines/Magazine_9x19_M9_15rnd_Ball.et" },
      ...
      { mode: "SUPPORT_STATION", ref: "{AE578EEA4244D41F}Prefabs/Items/Equipment/Kits/MedicalKit_01/MedicalKit_01_US.et" },
      { mode: "", ref: "{0CF54B9A85D8E0D4}Prefabs/Items/Equipment/Binoculars/Binoculars_M22/Binoculars_M22.et" },
      { mode: "", ref: "{61D4F80E49BF9B12}Prefabs/Items/Equipment/Compass/Compass_SY183.et" },
      { mode: "", ref: "{922F95F91943F69A}Prefabs/Items/Equipment/Maps/PaperMap_01_folded_US.et" },
      { mode: "", ref: "{3A421547BC29F679}Prefabs/Items/Equipment/Flashlights/Flashlight_MX991/Flashlight_MX991.et" },
      { mode: "", ref: "{6E35D94130954509}Prefabs/Items/Equipment/Accessories/ETool_ALICE/ETool_ALICE_FreeRoamBuilding_Gadget.et" },
      { mode: "", ref: "{78ED4FEF62BBA728}Prefabs/Items/Equipment/Watches/Watch_SandY184A.et" },
      { mode: "", ref: "{73950FBA2D7DB5C5}Prefabs/Items/Equipment/Radios/Radio_ANPRC68.et" },
      { mode: "SUPPORT_STATION", ref: "{33B2DFDCD0EBA3DB}Prefabs/Items/Equipment/Kits/RepairKit_01/RepairKit_01_wrench.et" },
      ...
      { mode: "", ref: "{2835A0EA3B79E63E}Prefabs/Characters/Vests/Vest_ALICE/Variants/Vest_ALICE_rifleman.et" },
      { mode: "", ref: "{156DC7109CEE6F69}Prefabs/Characters/Vests/Vest_ALICE/Variants/Vest_ALICE_AR.et" },
      { mode: "", ref: "{18B8B9316B590643}Prefabs/Characters/Vests/Vest_ALICE/Variants/Vest_ALICE_GL.et" },
      { mode: "", ref: "{477A190AF2A17B8A}Prefabs/Characters/Vests/Vest_ALICE/Variants/Vest_ALICE_MG.et" },
      { mode: "", ref: "{4B57C11AA5161760}Prefabs/Characters/Vests/Vest_PASGT/Vest_PASGT.et" },
      { mode: "ATTACHMENT", ref: "{BD496EE1B40DC510}Prefabs/Weapons/Attachments/Optics/Optic_4x20/Optic_4x20.et" },
      { mode: "ATTACHMENT", ref: "{D2018EDB1BBF4C88}Prefabs/Weapons/Attachments/Optics/Optic_ARTII/Optic_ARTII.et" },
      { mode: "ATTACHMENT", ref: "{08286DDBB1F33FF1}Prefabs/Weapons/Attachments/Optics/Optic_AP2k/Collim_AP2k.et" },
      { mode: "ATTACHMENT", ref: "{E52C9791E1554A5F}Prefabs/Weapons/Attachments/Muzzle/Suppressor_M16/Suppressor_M16.et" },
      { mode: "ATTACHMENT", ref: "{6288A1F1A5E3AC37}Prefabs/Weapons/Attachments/Muzzle/FlashHider_M16A2/FlashHider_M16.et" },
      { mode: "ATTACHMENT", ref: "{558117556F3880A8}Prefabs/Weapons/Attachments/Bayonets/Bayonet_M9.et" },
    ],
  ...
  USSR: {
    ...
    // reforger-item-database). Baked per playable faction — not user-editable.
    arsenalItems: [
      { mode: "WEAPON", ref: "{FA5C25BF66A53DCF}Prefabs/Weapons/Rifles/AK74/Rifle_AK74.et" },
      { mode: "WEAPON", ref: "{63E8322E2ADD4AA7}Prefabs/Weapons/Rifles/AK74/Rifle_AK74_GP25.et" },
      { mode: "WEAPON", ref: "{BFEA719491610A45}Prefabs/Weapons/Rifles/AKS74U/Rifle_AKS74U.et" },
      { mode: "WEAPON", ref: "{A7AF84C6C58BA3E8}Prefabs/Weapons/MachineGuns/RPK74/MG_RPK74.et" },
      { mode: "WEAPON", ref: "{A89BC9D55FFB4CD8}Prefabs/Weapons/MachineGuns/PKM/MG_PKM.et" },
      { mode: "WEAPON_VARIANTS", ref: "{6415B7923DE28C1B}Prefabs/Weapons/Rifles/SVD/Rifle_SVD_PSO.et" },
      { mode: "WEAPON", ref: "{C0F7DD85A86B2900}Prefabs/Weapons/Handguns/PM/Handgun_PM.et" },
      ...
      { mode: "AMMUNITION", ref: "{BBB50A815A2F916B}Prefabs/Weapons/Magazines/Magazine_545x39_AK_30rnd_Ball.et" },
      ...
      { mode: "SUPPORT_STATION", ref: "{21EF98BFC1EB3793}Prefabs/Items/Equipment/Kits/MedicalKit_01/MedicalKit_01_USSR.et" },
      { mode: "", ref: "{243948B23D90BECB}Prefabs/Items/Equipment/Binoculars/Binoculars_B8/Binoculars_B8.et" },
      { mode: "", ref: "{F2539FA5706E51E4}Prefabs/Items/Equipment/Binoculars/Binoculars_B12/Binoculars_B12.et" },
      { mode: "", ref: "{7CEF68E2BC68CE71}Prefabs/Items/Equipment/Compass/Compass_Adrianov.et" },
      { mode: "", ref: "{F849217AB3BA88BE}Prefabs/Items/Equipment/Maps/PaperMap_01_folded_USSR.et" },
      ...
      { mode: "", ref: "{6FD6C96121905202}Prefabs/Items/Equipment/Watches/Watch_Vostok.et" },
      { mode: "", ref: "{E1A5D4B878AA8980}Prefabs/Items/Equipment/Radios/Radio_R148.et" },
      { mode: "SUPPORT_STATION", ref: "{33B2DFDCD0EBA3DB}Prefabs/Items/Equipment/Kits/RepairKit_01/RepairKit_01_wrench.et" },
      ...
      { mode: "", ref: "{08155E701A949620}Prefabs/Characters/Vests/Vest_SovietHarness/Variants/Vest_SovietHarness_rifleman.et" },
      { mode: "", ref: "{4711A4CAF64C4CEE}Prefabs/Characters/Vests/Vest_SovietHarness/Variants/Vest_SovietHarness_AR.et" },
      { mode: "", ref: "{15067AD09803580D}Prefabs/Characters/Vests/Vest_SovietHarness/Variants/Vest_SovietHarness_MG.et" },
      { mode: "", ref: "{9713FE6DDCC9510D}Prefabs/Characters/Vests/Vest_Lifchik/Vest_Lifchik.et" },
      { mode: "", ref: "{C8516078375CBE45}Prefabs/Characters/Vests/Vest_Lifchik/Vest_Lifchik_GL.et" },
      { mode: "", ref: "{ADE19B33DCBB9005}Prefabs/Characters/Vests/Vest_6B2/Vest_6B2.et" },
      { mode: "", ref: "{4CBDC206FEF9897C}Prefabs/Characters/Vests/Vest_6B3/Vest_6B3.et" },
      { mode: "ATTACHMENT", ref: "{ACDF49FACD0701A8}Prefabs/Weapons/Attachments/Optics/Optic_1P29/Optic_1P29.et" },
      { mode: "ATTACHMENT", ref: "{C850A33226B8F9C1}Prefabs/Weapons/Attachments/Optics/Optic_PSO1/Optic_PSO1.et" },
      { mode: "ATTACHMENT", ref: "{E5E9DBBF3BFB88C6}Prefabs/Weapons/Attachments/Optics/Optic_PGO7/Optic_PGO7V3.et" },
      { mode: "ATTACHMENT", ref: "{3B96FAC169E27037}Prefabs/Weapons/Attachments/Muzzle/Suppressor_PBS4/Suppressor_PBS4.et" },
      { mode: "ATTACHMENT", ref: "{4A815EB8B824974A}Prefabs/Weapons/Attachments/Muzzle/FlashHider_AK74/FlashHider_AK74.et" },
      { mode: "ATTACHMENT", ref: "{98C79F5FAE12F9B6}Prefabs/Weapons/Attachments/Bayonets/Bayonet_6Kh4.et" },
    ],
    vehicles: {
  ...
  FIA: {
    ...
    // reforger-item-database). Baked per playable faction — not user-editable.
    arsenalItems: [
      { mode: "WEAPON", ref: "{9C948630078D154D}Prefabs/Weapons/Rifles/VZ58/Rifle_VZ58P.et" },
      { mode: "WEAPON", ref: "{443CEFF17E040B11}Prefabs/Weapons/Rifles/VZ58/Rifle_VZ58V.et" },
      { mode: "WEAPON", ref: "{026CE108BFB3EC03}Prefabs/Weapons/MachineGuns/UK59/MG_UK59.et" },
      { mode: "WEAPON", ref: "{3EB02CDAD5F23C82}Prefabs/Weapons/Rifles/SVD/Rifle_SVD.et" },
      { mode: "WEAPON_VARIANTS", ref: "{6415B7923DE28C1B}Prefabs/Weapons/Rifles/SVD/Rifle_SVD_PSO.et" },
      { mode: "WEAPON", ref: "{C0F7DD85A86B2900}Prefabs/Weapons/Handguns/PM/Handgun_PM.et" },
      { mode: "WEAPON", ref: "{7A82FE978603F137}Prefabs/Weapons/Launchers/RPG7/Launcher_RPG7.et" },
      ...
      { mode: "CONSUMABLE", ref: "{527D7C5D2E476BDC}Prefabs/Items/Medicine/SalineBag_01/SalineBag_USSR_01.et" },
      { mode: "CONSUMABLE", ref: "{80E75A71C29190DB}Prefabs/Items/Medicine/Tourniquet_01/Tourniquet_USSR_01.et" },
      { mode: "SUPPORT_STATION", ref: "{9132672C4D9B2102}Prefabs/Items/Equipment/Kits/MedicalKit_01/MedicalKit_01_FIA.et" },
      { mode: "", ref: "{243948B23D90BECB}Prefabs/Items/Equipment/Binoculars/Binoculars_B8/Binoculars_B8.et" },
      { mode: "", ref: "{F2539FA5706E51E4}Prefabs/Items/Equipment/Binoculars/Binoculars_B12/Binoculars_B12.et" },
      { mode: "", ref: "{7CEF68E2BC68CE71}Prefabs/Items/Equipment/Compass/Compass_Adrianov.et" },
      { mode: "", ref: "{983B57B8E95C1F52}Prefabs/Items/Equipment/Maps/PaperMap_01_folded_FIA.et" },
      { mode: "", ref: "{575EA58E67448C2A}Prefabs/Items/Equipment/Flashlights/Flashlight_Soviet_01/Flashlight_Soviet_01.et" },
      { mode: "", ref: "{062E2F1D7F6739D6}Prefabs/Items/Equipment/Accessories/ETool_MPL50/ETool_MPL50_FreeRoamBuilding_Gadget.et" },
      { mode: "", ref: "{61A705D76908160C}Prefabs/Items/Equipment/Watches/Watch_Orlik38/Watch_Orlik38.et" },
      { mode: "", ref: "{540C08AD5F21A5FA}Prefabs/Items/Equipment/Radios/Radio_R148_FIA.et" },
      { mode: "SUPPORT_STATION", ref: "{33B2DFDCD0EBA3DB}Prefabs/Items/Equipment/Kits/RepairKit_01/RepairKit_01_wrench.et" },
      ...
      { mode: "", ref: "{73EFD7591F4134D3}Prefabs/Items/Equipment/Radios/Radio_RF10/Radio_RF10.et" },
      { mode: "", ref: "{ED5574EA7F63B457}Prefabs/Characters/Vests/Vest_Type56/Vest_Type56.et" },
      { mode: "", ref: "{ADE19B33DCBB9005}Prefabs/Characters/Vests/Vest_6B2/Vest_6B2.et" },
      { mode: "ATTACHMENT", ref: "{C850A33226B8F9C1}Prefabs/Weapons/Attachments/Optics/Optic_PSO1/Optic_PSO1.et" },
      { mode: "ATTACHMENT", ref: "{886A96EF3F14BCD2}Prefabs/Weapons/Attachments/Optics/UK59_4x8/Optic_UK59_4x8.et" },
      { mode: "ATTACHMENT", ref: "{3F1B1BAD1F6DDC28}Prefabs/Weapons/Attachments/Bayonets/Bayonet_VZ58/Bayonet_VZ58_v1.et" },
    ],
    vehicles: {
