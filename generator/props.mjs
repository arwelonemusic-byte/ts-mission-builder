...
export const PROPS = [
  ...
  { ref: `{C731CC083B954825}${SLOTTED}/SlotFlatSmall/E_Antenna_S_FIA_01.et`, label: "Antenna (FIA)", cat: "militaryBase", fp: { w: 5, len: 5 } },
  { ref: `{F7DC8BB193BCAF44}${SLOTTED}/SlotFlatSmall/E_Antenna_S_US_01.et`, label: "Antenna (US)", cat: "militaryBase", fp: { w: 5, len: 5 } },
  { ref: `{0E9BAF79B9D47993}${SLOTTED}/SlotFlatSmall/E_Antenna_S_USSR_01.et`, label: "Antenna (Soviet)", cat: "militaryBase", fp: { w: 5, len: 5 } },
