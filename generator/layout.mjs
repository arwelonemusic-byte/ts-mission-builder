...
export function vehicleSizeClass(key) {
  ...
  // WCS T-72 (2026-09-22): 3.6 x 6.8 m MBT hull -> heavy.
  if (/^(M923A1|Ural4320|BTR70|BRDM2|LAV25|M998_covered_long|WCS_M1A[12]_|WCS_BMP[13]P?_|WCS_Stryker_|WCS_M108[0-9]_|WCS_M109[0-9]_|BWAR_Dingo2|MARDER_|WCS_T72[AB]_)/.test(key)) return "heavy";
  return "light";
}
